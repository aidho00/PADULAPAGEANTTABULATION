...
Module Connection
    ...
    Public str_userid, str_user, str_name, str_role, str_school, str_address
    Public str_user_number As Integer
    ...
    Public systemdbname As String = "padulapageant"
    ...
    Sub Connection1()
        ...
        Dim dbname As String = systemdbname
